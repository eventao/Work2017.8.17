...
let initScene, render, createShape, NoiseGen, loader,orbControl,
...
initScene = function() {
  ...
  ground_material = Physijs.createMaterial(
    new THREE.MeshLambertMaterial({ map: loader.load( 'assets/imgs/grass.png' ) }),
    .8, // high friction
    .4 // low restitution
  );
